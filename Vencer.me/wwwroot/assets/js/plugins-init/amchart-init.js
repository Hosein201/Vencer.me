$(document).ready(function () {
    ...
    var chart = AmCharts.makeChart("combined-bullet", {
        ...
        "valueAxes": [{
            ...
            "labelFunction": function (value) {
                return "م " + Math.round(value) + " تومان";
            }
        }, {
            "id": "v2",
            "title": "قیمت روز",
        ...
        "graphs": [{
            ...
            "clustered": false,
            "columnWidth": 0.5,
            "legendValueText": "[[value]] میلیون تومان",
            "balloonText": "[[title]]<br /><b style='font-size: 130%'>[[value]] میلیون تومان</b>"
        }, {
            "id": "g4",
            "valueAxis": "v1",
            "lineColor": "#03A9F5",
    ...
    var chart = AmCharts.makeChart("duration-value-axis", {
        ...
        "graphs": [{
            ...
            "fillAlphas": 0.9,
            "valueAxis": "a1",
            "balloonText": "[[value]] کیلومتر",
            "legendValueText": "[[value]] کیلومتر",
            "legendPeriodValueText": "کل : [[value.sum]] کیلومتر",
            "lineColor": "#428bca",
            "alphaField": "alpha"
        }, {
            "id": "g2",
            ...
            "labelText": "[[townName2]]",
            "labelPosition": "right",
            "balloonText": "طول جغرافیایی : [[value]]",
            "showBalloon": true,
    ...
    var chart = AmCharts.makeChart("professional-candlesticks", {
        ...
        "graphs": [{
            ...
            "balloonText": "باز : <b>[[open]]</b><br>کم : <b>[[low]]</b><br>بلند : <b>[[high]]</b><br>بسته : <b>[[close]]</b><br>",
            "closeField": "close",
            "fillColors": "#00A2FF",
            "highField": "high",
            "lineColor": "#00A2FF",
