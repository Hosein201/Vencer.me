! function (e, t) {
    ...
    var We = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        He = "ژانویه_فوریه_مارس_آپریل_می_ژوئن_جولای_آگوست_سپتامبر_اکتبر_نوامبر_دسامبر".split("_");
    var Re = "ژانویه_فوریه_مارس_آپریل_می_ژوئن_جولای_آگوست_سپتامبر_اکتبر_نوامبر_دسامبر".split("_");
