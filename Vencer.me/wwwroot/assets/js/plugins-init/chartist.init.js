...
var chart = new Chartist.Line('#svg-animation', {
  labels: ['شنبه', 'یک شنبه', 'دوشنبه', 'سه شنبه', 'چهارشنبه', 'پنج شنبه'],
  series: [
    [1, 5, 2, 5, 4, 3],
    [2, 3, 4, 8, 1, 2],
    [5, 4, 3, 2, 1, 0.5]
...
var data = {
  labels: ['ب1', 'ب2', 'ب3', 'ب4', 'ب5', 'ب6', 'ب7', 'ب8', 'ب9', 'ب10'],
  series: [
    [1, 2, 4, 8, 6, -2, -1, -4, -6, -2]
  ]
};
...
var data = {
  labels: ['فرو', 'ارد', 'خرد', 'تیر', 'مرد', 'شهر', 'مهر', 'آبا', 'آذر', 'دی', 'بهمن', 'اسف'],
  series: [
...
new Chartist.Bar('#multi-line-chart', {
  labels: ['فصل اول سال', 'فصل دوم سال', 'فصل سوم سال', 'فصل چهارم سال'],
  series: [
