...
! function (t, e) {
    ...
    t.summernote = t.summernote || {
        ...
        "en-US": {
            ...
            link: {
                link: "لینک",
                insert: "قراردادن لینک",
                unlink: "حذف لینک",
                edit: "ویرایش",
                textToDisplay: "Text to display",
                url: "To what URL should this link go?",
                openInNewWindow: "باز کردن در صفحه جدید"
            },
            table: {
                table: "جدول",
                addRowAbove: "افزودن ردیف به بالا",
                addRowBelow: "افزودن ردیف به پایین",
                addColLeft: "افزودن ستون به چپ",
                addColRight: "افزودن ستون به راست",
                delRow: "حذف ردیف",
                delCol: "حذف ستون",
                delTable: "حرف جدول"
            },
            ...
            color: {
                ...
                foreground: "رنگ متن",
                transparent: "والد",
                setTransparent: "رنگ والد",
                reset: "تنظیم مجدد",
                resetToDefault: "بازگشت به پیش فرض"
            },
            shortcut: {
                shortcuts: "کد های کوتاه کیبورد",
                close: "بستن",
            ...
            help: {
                insertParagraph: "قرار دادن پاراگراف",
                undo: "رفتن به قبلی",
                redo: "رفتن به بعدی",
                tab: "تب",
                untab: "حذف تب",
                bold: "استایل بولد",
                italic: "استایل ایتالیک",
                underline: "استایل زیر خط",
                strikethrough: "استایل خط خورده",
                removeFormat: "پاک کردن استایل",
                justifyLeft: "چپ چین",
                justifyCenter: "وسط چین",
                justifyRight: "راست چین",
                justifyFull: "هم تراز",
                insertUnorderedList: "لیست غیر ترتیبی",
                insertOrderedList: "لیست ترتیبی",
                outdent: "فاصله بیرونی پاراگراف",
                indent: "تورفتگی پاراگراف",
                formatPara: "تغییر فرمت پاراگراف",
                formatH1: "تغییر به تگ عنوان H1",
                formatH2: "تغییر به تگ عنوان H2",
                formatH3: "تغییر به تگ عنوان H3",
                formatH4: "تغییر به تگ عنوان H4",
                formatH5: "تغییر به تگ عنوان H5",
                formatH6: "تغییر به تگ عنوان H6",
                insertHorizontalRule: "حالت افقی",
            ...
            specialChar: {
                specialChar: "کاراکتر مخصوص",
                select: "انتخاب کاراکتر مخصوص"
            }
        }
    });
    var Et = {
