$(function () {
    ...
    new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ["فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفند", "فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان"],
            datasets: [{
                    label: "تعداد املاک فروخته شده",
                    type: "line",
                    borderColor: "#f060b1",
    ...
    new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ["الف", "ب", "پ", "ت", "ث", "ج", "چ", "ح", "خ", "د", "ذ", "ر", "ز", "ژ", "س", "ش", "ص", "ض", "ط", "ظ", "ع", "غ", "ف", "ق", "ک", "گ", "ل", "م", ],
            datasets: [{
                label: '',
