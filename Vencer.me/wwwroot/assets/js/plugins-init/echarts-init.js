     ...
     var chartOneOption = {
         ...
         series : [
             ...
             },
             {
                 ...
                 markPoint : {
                     data : [
                         {name : 'حداقل در هفته', value : -2, xAxis: 1, yAxis: -1.5}
                     ]
                 },
                 markLine : {
                     data : [
     ...
     option = {
         ...
         series : [
             ...
             },
             {
                 ...
                 markPoint : {
                     data : [
                         {name : 'حداکثر', value : 182.2, xAxis: 7, yAxis: 183, symbolSize:18},
                         {name : 'حداقل', value : 2.3, xAxis: 11, yAxis: 3}
                     ]
                 },
                 markLine : {
                     data : [
    ...
    // <!--Basic Pie echarts init-->
     ...
     option = {
         ...
         legend: {
             orient : 'vertical',
             x : 'left',
             data:['دایرکت','ایمیل','تحقیق','تبلیغ','جستجو']
         },
         calculable : true,
         series : [
             {
                 ...
                 center: ['50%', '60%'],
                 data:[
                     {value:335, name:'دایرکت'},
                     {value:310, name:'ایمیل'},
                     {value:234, name:'تحقیق'},
                     {value:135, name:'تبلیغ'},
                     {value:1548, name:'جستجو'}
                 ]
             }
         ]
     };
    ...
    // <!--Nested Pie echarts init-->
     ...
     option = {
         ...
         legend: {
             orient : 'vertical',
             x : 'left',
             data:['دایرکت','تبلیغ','جستجو','ایمیل','تحقیق','ویدئو','یاهو','گوگل','بینگ','دیگر']
         },
         calculable : false,
         series : [
             {
                 ...
                 data:[
                     {value:335, name:'دایرکت'},
                     {value:679, name:'تبلیغ'},
                     {value:1548, name:'جستجو', selected:true}
                 ]
             },
             {
                 name:'منبع',
                 ...
                 data:[
                     ...
                     {value:310, name:'ایمیل'},
                     {value:234, name:'تحقیق'},
                     {value:135, name:'ویدئو'},
                     {value:1048, name:'یاهو'},
                     {value:251, name:'گوگل'},
                     {value:147, name:'بینگ'},
                     {value:102, name:'دیگر'}
                 ]
    ...
    // <!--Radar echarts init-->
     ...
     option = {
         ...
         legend: {
             ...
             x : 'left',
             y : 0,
             data:['بودجه اختصاص داده','هزینه واقعی']
         },
         polar : [
             {
                 indicator : [
                     { text: 'فروش', max: 6000},
                     { text: 'مدیر سیستم', max: 16000},
                     { text: 'تکنولوژی اطلاعات', max: 30000},
                     { text: 'پشتیبانی مشتری', max: 38000},
                     { text: 'توسعه', max: 52000},
                     { text: 'مارکتینگ', max: 25000}
                 ]
             }
         ],
         calculable : true,
