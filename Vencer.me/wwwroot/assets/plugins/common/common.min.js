...
! function (e, t) {
  ...
  ! function (F) {
    ...
    c.VERSION = "1.13.2", c.BootstrapVersion = _.major, c.DEFAULTS = {
      noneSelectedText: "چیزی انتخاب نشده",
      noneResultsText: "نتیجه ای یافت نشد {0}",
      countSelectedText: function (e, t) {
        return 1 == e ? "{0} مورد انتخاب شد" : "{0} مورد انتخاب شد"
      },
      maxOptionsText: function (e, t) {
        return [1 == e ? "محدودیت انتخاب (حداکثر {n} مورد)" : "محدودیت انتخاب (حداکثر {n} مورد)", 1 == t ? "محدودیت انتخاب گروهی (حداکثر {n} مورد)" : "محدودیت انتخاب گروهی (حداکثر {n} مورد)"]
      },
