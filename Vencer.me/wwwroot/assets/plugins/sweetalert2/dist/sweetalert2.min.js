(function (e, t) {
    ...
    function n(e) {
        ...
        var l = M(),
            ...
            m = X(),
            b = J();
        if (e.titleText ? d.innerText = e.titleText : e.title && (d.innerHTML = e.title.split("\n").join("<br />")), "string" == typeof e.backdrop ? M().style.background = e.backdrop : !e.backdrop && L([document.documentElement, document.body], k["no-backdrop"]), e.html ? oe(e.html, u) : e.text ? (u.textContent = e.text, T(u)) : V(u), e.position in k ? L(l, k[e.position]) : (f("The \"position\" parameter is not valid, defaulting to \"center\""), L(l, k.center)), e.grow && "string" == typeof e.grow) {
            var y = "grow-" + e.grow;
            y in k && L(l, k[y])
        }
        ...
        e.progressSteps && e.progressSteps.length ? (T(v), q(v), w >= e.progressSteps.length && f("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), e.progressSteps.forEach(function (t, n) {
            var o = document.createElement("li");
            if (L(o, k.progresscircle), o.innerHTML = t, n === w && L(o, k.activeprogressstep), v.appendChild(o), n !== e.progressSteps.length - 1) {
                var i = document.createElement("li");
                L(i, k.progressline), e.progressStepsDistance && (i.style.width = e.progressStepsDistance), v.appendChild(i)
            }
        })) : V(v);
        for (var C = I(), x = 0; x < C.length; x++) V(C[x]);
        if (e.type) {
            var A = !1;
            for (var E in B)
                if (e.type === E) {
                    A = !0;
                    break
                } if (!A) return h("Unknown alert type: " + e.type), !1;
            var S = t.querySelector("." + k.icon + "." + B[e.type]);
            T(S), e.animation && L(S, "swal2-animate-" + e.type + "-icon")
        }
        var P = U();
        if (e.imageUrl ? (P.setAttribute("src", e.imageUrl), P.setAttribute("alt", e.imageAlt), T(P), e.imageWidth ? P.setAttribute("width", e.imageWidth) : P.removeAttribute("width"), e.imageHeight ? P.setAttribute("height", e.imageHeight) : P.removeAttribute("height"), P.className = k.image, e.imageClass && L(P, e.imageClass)) : V(P), e.showCancelButton ? g.style.display = "inline-block" : V(g), e.showConfirmButton ? j(p, "display") : V(p), e.showConfirmButton || e.showCancelButton ? T(c) : V(c), p.innerHTML = e.confirmButtonText, g.innerHTML = e.cancelButtonText, p.setAttribute("aria-label", e.confirmButtonAriaLabel), g.setAttribute("aria-label", e.cancelButtonAriaLabel), p.className = k.confirm, L(p, e.confirmButtonClass), g.className = k.cancel, L(g, e.cancelButtonClass), e.buttonsStyling) {
            L([p, g], k.styled), e.confirmButtonColor && (p.style.backgroundColor = e.confirmButtonColor), e.cancelButtonColor && (g.style.backgroundColor = e.cancelButtonColor);
            var O = window.getComputedStyle(p).getPropertyValue("background-color");
            p.style.borderLeftColor = O, p.style.borderRightColor = O
        } else _([p, g], k.styled), p.style.backgroundColor = p.style.borderLeftColor = p.style.borderRightColor = "", g.style.backgroundColor = g.style.borderLeftColor = g.style.borderRightColor = "";
        oe(e.footer, b), !0 === e.animation ? _(t, k.noanimation) : L(t, k.noanimation), e.showLoaderOnConfirm && !e.preConfirm && f("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request")
    }
    ...
    var a = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
        ...
        ne = function (e) {
            ...
            var g = void 0,
                m = function (t) {
                    Oe.isVisible() && g !== t.target.value && Oe.resetValidationError(), g = t.target.value
                };
            return r.oninput = m, s.onchange = m, u.onchange = m, c.onchange = m, p.oninput = m, l.oninput = function (t) {
                m(t), d.value = l.value
            }, l.onchange = function (t) {
                m(t), l.nextSibling.value = l.value
            }, i
        },
        oe = function (e, t) {
            if (!e) return V(t);
    ...
    var Ae = {
        ...
        Ee = function e(t, n) {
            ...
            var o, a, r, s = n;
            this.start = function () {
                r = !0, a = new Date, o = setTimeout(t, s)
            }, this.stop = function () {
                r = !1, clearTimeout(o), s -= new Date - a
            }, this.getTimerLeft = function () {
                return r && (this.stop(), this.start()), s
        ...
        Le = Object.freeze({
            ...
            _main: function (e) {
                ...
                be(e);
                var o = s({}, ge, e);
                n(o), Object.freeze(o), Ae.innerParams.set(this, o), ue.timeout && (ue.timeout.stop(), delete ue.timeout);
                var r = {
                    popup: R(),
                    container: M(),
                    content: W(),
                ...
                return new Promise(function (e, n) {
                    ...
                    if (r.closeButton.onclick = function () {
                        ...
                        r.popup.onmousedown = function () {
                            r.container.onmouseup = function (t) {
                                r.container.onmouseup = void 0, t.target === r.container && (C = !0)
                            }
                        }, r.container.onmousedown = function () {
                            r.popup.onmouseup = function (t) {
                                r.popup.onmouseup = void 0, (t.target === r.popup || r.popup.contains(t.target)) && (C = !0)
                            }
                            ...
                            if ("Enter" === n.key && !n.isComposing) {
                                ...
                                for (var o = n.target || n.srcElement, i = G(e.focusCancel), a = -1, s = 0; s < i.length; s++)
                                    if (o === i[s]) {
                                        a = s;
                                        break
                                    } n.shiftKey ? x(a, -1) : x(a, 1), n.stopPropagation(), n.preventDefault()
                    ...
                    for (var A = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], E = void 0, P = 0; P < A.length; P++) {
                        var _ = k[A[P]],
                            q = O(r.content, _);
                        if (E = t.getInput(A[P]), E) {
                            for (var M in E.attributes)
                                if (E.attributes.hasOwnProperty(M)) {
                                    var j = E.attributes[M].name;
                                    "type" !== j && "value" !== j && E.removeAttribute(j)
                                } for (var D in o.inputAttributes) E.setAttribute(D, o.inputAttributes[D])
                        }
                        q.className = _, o.inputClass && L(q, o.inputClass), V(q)
                    }
                    var R;
                    switch (o.input) {
                        case "text":
                        ...
                        case "tel":
                        case "url":
                            E = O(r.content, k.input), E.value = o.inputValue, E.placeholder = o.inputPlaceholder, E.type = o.input, T(E);
                            break;
                        case "file":
                            E = O(r.content, k.file), E.placeholder = o.inputPlaceholder, E.type = o.input, T(E);
                            break;
                        case "range":
                            var I = O(r.content, k.range),
                                N = I.querySelector("input"),
                                W = I.querySelector("output");
                            N.value = o.inputValue, N.type = o.input, W.value = o.inputValue, T(I);
                            break;
                        case "select":
                            var U = O(r.content, k.select);
                            if (U.innerHTML = "", o.inputPlaceholder) {
                                var K = document.createElement("option");
                                K.innerHTML = o.inputPlaceholder, K.value = "", K.disabled = !0, K.selected = !0, U.appendChild(K)
                            }
                            R = function (e) {
                                e.forEach(function (e) {
                                    ...
                                    a.value = n, a.innerHTML = i, o.inputValue.toString() === n.toString() && (a.selected = !0), U.appendChild(a)
                                }), T(U), U.focus()
                            };
                            break;
                        case "radio":
                            var z = O(r.content, k.radio);
                            z.innerHTML = "", R = function (e) {
                                e.forEach(function (e) {
                                    var t = c(e, 2),
                                        n = t[0],
                                        i = t[1],
                                    ...
                                    a.type = "radio", a.name = k.radio, a.value = n, o.inputValue.toString() === n.toString() && (a.checked = !0), r.innerHTML = i, r.insertBefore(a, r.firstChild), z.appendChild(r)
                                }), T(z);
                        ...
                        case "checkbox":
                            ...
                            Y.type = "checkbox", Y.value = 1, Y.id = k.checkbox, Y.checked = !!o.inputValue;
                            var Q = F.getElementsByTagName("span");
                            Q.length && F.removeChild(Q[0]), Q = document.createElement("span"), Q.innerHTML = o.inputPlaceholder, F.appendChild(Q), T(F);
                            break;
                        case "textarea":
                            var J = O(r.content, k.textarea);
                            J.value = o.inputValue, J.placeholder = o.inputPlaceholder, T(J);
                            break;
                        case null:
                            break;
                        default:
                    ...
                    } else -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(o.input) && w(o.inputValue) && (l.showLoading(), V(E), o.inputValue.then(function (e) {
                        E.value = "number" === o.input ? parseFloat(e) || 0 : e + "", T(E), t.hideLoading()
                    }).catch(function (e) {
                        h("Error in inputValue promise: " + e), E.value = "", T(E), t.hideLoading()
                    }));
                    Pe(o), o.toast || (v(o.allowEnterKey) ? o.focusCancel && H(r.cancelButton) ? r.cancelButton.focus() : o.focusConfirm && H(r.confirmButton) ? r.confirmButton.focus() : x(-1, 1) : document.activeElement && document.activeElement.blur()), r.container.scrollTop = 0
                })
            }
        }),
        _e = void 0;
    o.prototype.then = function (e, t) {
        ...
        var t = Ae.promise.get(this);
        return t.finally(e)
    }, s(o.prototype, Le), s(o, ke), Object.keys(Le).forEach(function (e) {
        o[e] = function () {
            if (_e) {
                var t;
    ...
    }), o.DismissReason = C, o.noop = function () {}, o.version = "7.22.0";
    var Oe = e(function (e) {
        var t = function (t) {
            function n() {
                return i(this, n), u(this, (n.__proto__ || Object.getPrototypeOf(n)).apply(this, arguments))
