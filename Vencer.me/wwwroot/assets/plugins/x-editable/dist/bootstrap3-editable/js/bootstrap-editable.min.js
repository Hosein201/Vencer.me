...
function (a) {
    ...
    a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput), a.extend(b.prototype, {
        ...
        source: null,
        prepend: !1,
        sourceError: "خطا هنگام بارگزاری لیست",
        sourceCache: !0,
        sourceOptions: null
...
function (a) {
    ...
    a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput), a.extend(b.prototype, {
        ...
        renderClear: function () {
            this.options.clear && (this.$clear = a('<span class="editable-clear-x"></span>'), this.$input.after(this.$clear).css("padding-left", 24).keyup(a.proxy(function (b) {
...
function (a) {
    ...
    var k = a.fn.datepicker.dates = {
            en: {
                days: ["شنبه", "یکشنبه", "دوشنبه", "سه شنبه", "چهارشنبه", "پنج شنبه", "جمعه", "شنبه"],
                daysShort: ["شنبه", "یکشنبه", "دوشنبه", "سه شنبه", "چهارشنبه", "پنج شنبه", "جمعه", "شنبه"],
