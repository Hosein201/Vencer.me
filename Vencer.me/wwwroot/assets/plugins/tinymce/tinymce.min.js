...
! function () {
        ...
        Se = function () {
            ...
            b.bind = function (e, t, n, r) {
                ...
                if (e && 3 !== e.nodeType && 8 !== e.nodeType) {
                    for (e[g] ? o = e[g] : (o = m++, e[g] = o, y[o] = {}), r = r || e, a = (t = t.split(" ")).length; a--;) c = d, s = l = !1, "DOMContentLoaded" === (u = t[a]) && (u = "ready"), b.domLoaded && "ready" === u && "complete" === e.readyState ? n.call(r, Ne({
                        type: u
                    ...
                    return 1 === g && 0 === p ? function (e) {
                        ...
                        if (l) {
                            ...
                            if (s = [v ? l.firstChild : l.lastChild], v && d) {
                                ...
                                for (;
                                    (i = ++u && i && i[c] || (a = u = 0) || s.pop()) && ((b ? i.nodeName.toLowerCase() !== f : 1 !== i.nodeType) || !++a || (d && ((i[qe] || (i[qe] = {}))[m] = [We, a]), i !== e)););
    ...
    function Ft(m, g, p, h, v, e) {
        return h && !h[qe] && (h = Ft(h)), v && !v[qe] && (v = Ft(v, e)), Tt(function (e, t, n, r) {
            var o, i, a, u = [],
                ...
                d = p ? v || (e ? m : c || h) ? [] : t : f;
            if (p && p(f, d, n, r), h)
                for (o = Mt(d, s), h(o, [], n, r), i = o.length; i--;)(a = o[i]) && (d[s[i]] = !(f[s[i]] = a));
            if (e) {
                if (v || m) {
                    if (v) {
        ...
        for (var r, t, n, o = e.length, i = Ae.relative[e[0].type], a = i || Ae.relative[" "], u = i ? 1 : 0, s = Lt(function (e) {
            ...
            if (t = Ae.relative[e[u].type]) l = [Lt(It(l), t)];
                ...
                if ((t = Ae.filter[e[u].type].apply(null, e[u].matches))[qe]) {
                    ...
                    return Ft(1 < u && It(l), 1 < u && Pt(e.slice(0, u - 1).concat({
                        value: " " === e[u - 2].type ? "*" : ""
    ...
    Ot.prototype = Ae.filters = Ae.pseudos, Ae.setFilters = new Ot, De = St.tokenize = function (e, t) {
        ...
        if (n = n || [], 1 === l.length) {
            ...
            for (o = ht.needsContext.test(e) ? 0 : i.length; o-- && (a = i[o], !Ae.relative[u = a.type]);)
                if ((s = Ae.find[u]) && (r = s(a.matches[0].replace(Nt, Et), xt.test(i[0].type) && Bt(t.parentNode) || t))) {
    ...
    gn.fn = gn.prototype = {
        ...
        init: function (e, t) {
            ...
            if (nn(e)) {
                ...
                if (n[1])
                    for (r = rn(e, yn(t)).firstChild; r;) Gt.call(o, r), r = r.nextSibling;
                else {
    ...
    var En, Sn, kn, Tn = function (e, t) {
        ...
        Zn = function (e) {
            var t, n, r, o, i, a, u, s, c, l, f, d = Qn.browsers(),
                m = Qn.oses(),
        ...
        or = (Node.DOCUMENT_TYPE_NODE, Node.DOCUMENT_FRAGMENT_NODE, Node.ELEMENT_NODE),
        ir = Node.TEXT_NODE,
    ...
    var zi, Ui = function (e, t, n) {
        ...
        su = function (e) {
            ...
            if ($a(e.container()))
                if (e.isAtEnd()) n = eu(e.container(), e.offset()), Ja(n) && i(n, n.data.length), Ya(n) && !Qa(n) && o(uu(au(n), !1));
                else {
    ...
    var lu, fu, du = cu,
        ...
        Cu = function (e, t) {
            ...
            return n = t.container(), r = t.offset(), mu(n) ? o = function (e, t) {
                for (;
                    (e = e.previousSibling) && mu(e);) t += e.data.length;
                return t
        ...
        Du = function (e, t) {
            ...
            return r.insertNode(l), Eu(l.previousSibling), Eu(l.nextSibling), e.moveToBookmark({
                id: o,
                keep: 1
            }), {
                id: o
    ...
    var Qu, Zu, es = Ao.isContentEditableFalse,
        ts = Ao.isText,
        ns = Ao.isElement,
        rs = Ao.isBr,
        os = Ra,
    ...
    var fs, ds, ms, gs, ps, hs = function (e, t) {
        ...
        xc = Ao.matchStyleValues("display", "block table table-cell table-caption list-item"),
        wc = ga,
        Nc = da,
        Ec = ia.curry,
        Sc = Ao.isElement,
        ...
        ml = {
            ...
            moveStart: function (e, t, n) {
                var r, o, i, a = n.startOffset,
                    u = n.startContainer;
                if ((n.startContainer !== n.endContainer || !ll(n.startContainer.childNodes[n.startOffset])) && 1 === u.nodeType)
                    for (a < (i = u.childNodes).length ? r = new to(u = i[a], e.getParent(u, e.isBlock)) : (r = new to(u = i[i.length - 1], e.getParent(u, e.isBlock))).next(!0), o = r.current(); o; o = r.next())
        ...
        xl = function (e, t, n, r, o, i) {
            var a, u, s, c;
            if (3 === n.nodeType) {
                if (-1 !== (s = Cl(o, i, n, r))) return {
                    container: n,
                    offset: s
                };
                c = n
            }
            for (a = new to(n, e.getParent(n, e.isBlock) || t); u = a[o ? "prev" : "next"]();)
                if (3 !== u.nodeType || gl(u.parentNode)) {
                    if (e.isBlock(u) || ml.isEq(u, "BR")) break
                } else if (-1 !== (s = Cl(o, i, c = u))) return {
                container: u,
                offset: s
            };
            if (c) return {
        ...
        Nl = function (t, e, n, r) {
            ...
            if (o && e[0].wrapper && (o = pl(i, o, "ul,ol").reverse()[0] || o), !o)
                for (o = n; o[r] && !i.isBlock(o[r]) && (o = o[r], !ml.isEq(o, "br")););
            return o || n
        },
        El = function (e, t, n, r, o, i, a) {
            ...
            for (;;) {
                ...
                for (c = s[l]; c; c = c[l])
                    if (!gl(c) && !hl(c) && ("BR" !== (d = c).nodeName || !d.getAttribute("data-mce-bogus") || d.nextSibling)) return s;
    ...
    function Ll(s) {
        ...
        return {
            ...
            getAll: function (e) {
                var t, n, r, o, i, a, u = (t = s, n = e, r = nr.fromDom(t.getBody()), o = Mi(r, "[" + Wi() + '="' + n + '"]'), i = {}, M(o, function (e) {
                    var t = vr(e, Ki()),
    ...
    var Zl = function (a) {
        ...
        rf = function (e, t, n) {
            ...
            if (/^ | $/.test(t) && (t = function (e, t) {
                ...
                }(g.getRng(), t)), r = e.parser, m = n.merge, o = Ql({
        ...
        Gf = function (e) {
            var n, r, o, t, i = nr.fromDom(e.getBody()),
        ...
        hd = function (t, n, e, r) {
            void 0 === r && (r = !0);
            var o, i = ld(n, t.getBody(), e.dom()),
                a = Ui(e, b(dd, t), (o = t.getBody(), function (e) {
                    return e.dom() === o
                })),
                u = gd(e, i, pd(t, e));
        ...
        Cd = function (e) {
            ...
            return Ao.isContentEditableTrue(n) && e.dom.isBlock(n) && e.dom.isEmpty(n) && (t = e.dom.create("br", {
                "data-mce-bogus": "1"
            }), e.dom.setHTML(n, ""), n.appendChild(t), e.selection.setRng(du.before(t).toRange())), !0
        },
        xd = Ao.isText,
        wd = function (e) {
        ...
        qm = function (e, t) {
            var n, r, o, i, a, u = nr.fromDom(e.selection.getStart(!0)),
                s = Pm(e);
        ...
        og = function (e, t, n) {
            for (var r = new to(t, e.getParent(t.parentNode, e.isBlock) || e.getRoot()); t = r[n ? "prev" : "next"]();)
        ...
        lg = function (e, t) {
            ...
            "LI" !== d || m || (l = f), s && 3 === s.nodeType && u >= s.nodeValue.length && (function (e, t, n) {
                for (var r, o = new to(t, n), i = e.getNonEmptyElements(); r = o.next();)
        ...
        vg = function (e, t) {
            var n, r, o, i = (n = e, r = b(Cf.isInlineTarget, n), o = du.fromRangeStart(n.selection.getRng()), Yd(r, n.getBody(), o).filter(pg));
    ...
    var qp = function (e) {
        ...
        Qp = function (n, r, o, t) {
            ...
            0 !== r.src.indexOf("blob:") ? (i = Yp(r.src).data, (a = n.findFirst(function (e) {
                ...
                image: r,
                blobInfo: a
            }) : Kp(r.src).then(function (e) {
                a = n.create(Jp(), e, i), n.add(a), o({
                    image: r,
                    blobInfo: a
                })
            }, function (e) {
                ...
                image: r,
                blobInfo: a
            }) : Kp(r.src).then(function (t) {
                Xp(t).then(function (e) {
                    i = Yp(e).data, a = n.create(Jp(), t, i), n.add(a), o({
                        image: r,
                        blobInfo: a
                    })
                })
        ...
        ah = function (e) {
            ...
            if (f = d.forced_root_block, v && Ao.isElement(v) && f && (l = b.nodeName.toLowerCase(), p.isValidChild(l, f.toLowerCase()) && !oh(h, b, v))) {
                for (n = (t = g.getRng()).startContainer, r = t.startOffset, o = t.endContainer, i = t.endOffset, c = xp(e), v = b.firstChild; v;)
                    if (y = h, C = v, Ao.isText(C) || Ao.isElement(C) && !rh(y, C) && !cl(C)) {
                        if (ih(h, v)) {
        ...
        Xh = function (g) {
            var p, e, t, a = g.getBody(),
                ...
                c = function (e, t) {
                    ...
                    }), r[0].focus(), (o = g.selection.getSel()).removeAllRanges(), o.addRange(e), M(Mi(nr.fromDom(g.getBody()), "*[data-mce-selected]"), function (e) {
            ...
            return fe.ceFalse && (function () {
                ...
                r = !1, (n = g).on("touchstart", function () {
                    ...
                    if ((n === a || "HTML" === n.nodeName || g.dom.isChildOf(n, a)) && !1 !== Ap(g, e.clientX, e.clientY))
                        if (t = Kh(g, n)) qh(t) ? (e.preventDefault(), c(Yu(g, t))) : (l(), jh(t) && e.shiftKey || Uh(e.clientX, e.clientY, g.selection.getRng()) || (C(), g.selection.placeCaretAt(e.clientX, e.clientY)));
                        else if (!1 === yc(n)) {
                        l(), C();
        ...
        return {
            parse: function (e) {
                ...
                for (S = new RegExp("<(?:(?:!--([\\w\\W]*?)--\x3e)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([A-Za-z][A-Za-z0-9\\-_\\:\\.]*)>)|(?:([A-Za-z][A-Za-z0-9\\-_\\:\\.]*)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), k = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, s = z.getShortEndedElements(), E = F.self_closing_elements || z.getSelfClosingElements(), g = z.getBoolAttrs(), p = F.validate, u = F.remove_internals, _ = F.fix_self_closing, T = z.getSpecialElements(), N = e + ">"; t = S.exec(N);) {
                    if (R < t.index && H(O(e.substr(R, t.index - R))), n = t[6]) ":" === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)), I(n);
                    else if (n = t[7]) {
    ...
    function hv(u) {
        ...
        return u.on("init", function () {
            ...
            undo: function () {
                var e;
                return o.typing && (o.add(), o.typing = !1, i(!1)), 0 < c && (e = l[--c], gv(u, e, !0), d(!0), u.fire("undo", {
                    level: e
                })), e
            },
            redo: function () {
                var e;
                return c < l.length - 1 && (e = l[++c], gv(u, e, !1), d(!0), u.fire("redo", {
                    level: e
                })), e
            },
            clear: function () {
            ...
            if (c)
                if ("undefined" == typeof c.length) {
                    ...
                    for (s = 0; s < c.length; s++)
                        if ("attributes" === r ? e.getAttrib(t, c[s]) : ml.getStyle(e, t, c[s])) return n;
            return n
        },
        Ev = function (e, t, n, r, o) {
            ...
            if (c && t)
                for (a = 0; a < c.length; a++)
                    if (i = c[a], wv(e.dom, t, i) && Nv(l, t, i, "attributes", o, r) && Nv(l, t, i, "styles", o, r)) {
                        if (s = i.classes)
        ...
        Sv = {
            ...
            canApply: function (e, t) {
                var n, r, o, i, a, u = e.formatter.get(t),
                    s = e.dom;
                if (u)
                    for (n = e.selection.getStart(), r = ml.getParents(s, n), i = u.length - 1; 0 <= i; i--) {
    ...
    var jv = function (e, t) {
        ...
        Zv = function (s, c, l, e, f) {
            var t, n, d = s.formatter.get(c),
                ...
                r = s.selection,
                i = function (e) {
                    var n, t, r, o, i, a, u = (n = s, t = e, r = c, o = l, i = f, $v(ml.getParents(n.dom, t.parentNode).reverse(), function (e) {
                        var t;
                ...
                g = function (e) {
                    var t, n, r, o, i;
                    if (Ao.isElement(e) && u.getContentEditable(e) && (o = a, a = "true" === u.getContentEditable(e), i = !0), t = Xt.grep(e.childNodes), a && !i)
            ...
            }(s, c, l, f) : (t = Bu.getPersistentBookmark(s.selection, !0), o(r.getRng()), r.moveToBookmark(t), m.inline && Sv.match(s, c, l, r.getStart()) && ml.moveStart(u, r, r.getRng()), s.nodeChanged());
            else {
                e = r.getNode();
        ...
        hb = function (g, p, h, r) {
            ...
            if ("false" !== i.getContentEditable(n.getNode())) {
                if (b) {
                    if (r) r.nodeType ? C(v, r) || ((t = i.createRng()).setStartBefore(r), t.setEndAfter(r), a(i, Sl(g, t, v), 0, !0)) : a(i, r, 0, !0);
    ...
    var Rb, Db = Object.prototype.hasOwnProperty,
        Bb = (Rb = function (e, t) {
            return t
        }, function () {
        ...
        Pb = {
            process: function (e, t, n) {
                ...
                }), o = "BODY" !== o.nodeName ? u.body.firstChild : u.body, s = c.doc, c.doc = u), $g(r, Bb(i, {
                    node: o
                })), s && (c.doc = s), o) : t;
            ...
            e = {
                ...
                parse: function (e, a) {
                    ...
                    if (t.parse(e), h && m.length && (a.context ? a.invalid = !0 : function (e) {
                            ...
                            for (d = Xb("tr,td,th,tbody,thead,tfoot,table"), l = T.getNonEmptyElements(), f = T.getWhiteSpaceElements(), m = T.getTextBlockElements(), g = T.getSpecialElements(), t = 0; t < e.length; t++)
    ...
    var Zb = function (e, t, n) {
        ...
        ny = function (e, t, n, r, o) {
            ...
            return a = e, s = c, !(u = o).no_events && a ? Wg(a, Bb(u, {
                content: s
            })).content : s
        };

    function ry(e, t) {
        var a, u, s, c, l, n, r = (a = e, n = ["data-mce-selected"], s = (u = t) && u.dom ? u.dom : di.DOM, c = u && u.schema ? u.schema : Zo(a), a.entity_encoding = a.entity_encoding || "named", a.remove_trailing_brs = !("remove_trailing_brs" in a) || a.remove_trailing_brs, l = Qb(a, c), Ob.register(l, a, s), {
            schema: c,
    ...
    var iy = oy,
        ...
        Ey = function (e, t) {
            var n, r = nr.fromDom(t.commonAncestorContainer),
                o = Ff(r, e),
                i = F(o, function (e) {
                    return so(e) || ao(e)
                }),
                a = Ny(o, t),
                u = i.concat(a.length ? a : mo(n = r) ? Lr(n).filter(fo).fold(j([]), function (e) {
                    return [n, e]
                }) : fo(n) ? [n] : []);
            return $(u, ea)
        },
                ...
                p = {
                    ...
                    getSelectedBlocks: function (e, t) {
                        return function (e, t, n, r) {
                            var o, i, a = [];
                            if (i = e.getRoot(), n = e.getParent(n || By(i, t, t.collapsed), e.isBlock), r = e.getParent(r || Oy(i, t, t.collapsed), e.isBlock), n && n !== i && a.push(n), n && r && n !== r)
                                for (var u = new to(o = n, i);
        ...
        qy = function (e, t, n, r) {
            var o, i, a, u, s, c, l = e === lu.Forwards,
                f = l ? Hy : Vy;
        ...
        Ky = function (l, f) {
            return function () {
                var e, t, n, r, o, i, a, u, s, c = (t = f, r = ls((e = l).getBody()), o = ia.curry(jy, r.next), i = ia.curry(jy, r.prev), a = t ? lu.Forwards : lu.Backwards, u = t ? o : i, s = e.selection.getRng(), (n = qy(a, e, u, s)) ? n : (n = Wy(e, a, s)) || null);
                return !!c && (l.selection.setRng(c), !0)
            }
        },
        Xy = function (u, s) {
            return function () {
                var e, t, n, r, o, i, a = (r = (t = s) ? 1 : -1, o = t ? _h : Ah, i = (e = u).selection.getRng(), (n = $y(r, e, o, i)) ? n : (n = Wy(e, r, i)) || null);
        ...
        gC = function (e, t, n, r, o) {
            ...
            if (n !== e.getBody()) {
                ...
                if (mC(n, r, !0) && mC(n, r, !1)) lC(n, "LI") ? i.insertAfter(l, dC(n)) : i.replace(l, n);
                else if (mC(n, r, !0)) lC(n, "LI") ? (i.insertAfter(l, dC(n)), l.appendChild(i.doc.createTextNode(" ")), l.appendChild(n)) : n.parentNode.insertBefore(l, n);
        ...
        xC = function (a, e) {
            var t, u, s, i, c, n, r, o, l, f, d, m, g, p, h, v, b, y, C = a.dom,
                ...
                E = function (e) {
                    ...
                    if (e || "TABLE" === f || "HR" === f ? (t = C.create(e || m), CC(a, t)) : t = c.cloneNode(!1), r = t, !1 === $s(a)) C.setAttrib(t, "style", null), C.setAttrib(t, "class", null);
                    else
                        do {
                            if (i[o.nodeName]) {
                                if (Pu(o)) continue;
            ...
            }(C, w, r), p = C, (h = c).normalize(), (v = h.lastChild) && !/^(left|right)$/gi.test(p.getStyle(v, "float", !0)) || p.add(h, "br"), C.isEmpty(c) && pC(c), r.normalize(), C.isEmpty(r) ? (C.remove(r), k()) : iC(a, r)), C.setAttrib(r, "id", ""), a.fire("NewBlock", {
                newBlock: r
            })))
        },
        wC = function (e, t) {
    ...
    var XC = function (e) {
        ...
        yx = function (r, e) {
            var t, n, o = this;
            if (r = hx(r), t = (e = o.settings = e || {}).base_uri, /^([\w\-]+):([^\/]{2})/i.test(r) || /^\s*#/.test(r)) o.source = r;
            else {
                var i = 0 === r.indexOf("//");
    ...
    var Cx = function (e, t, n) {
            var r, o, i, a, u;
            if (t.format = t.format ? t.format : "html", t.get = !0, t.getInner = !0, t.no_events || e.fire("BeforeGetContent", t), "raw" === t.format) r = Xt.trim(Zh.trimExternal(e.serializer, n.innerHTML));
        ...
        Ax = function (e) {
            if (!e.removed) {
                ...
                r && e.save({
                    is_removing: !0
                }), e.removed = !0, e.unbindAllNativeEvents(), e.hasHiddenInput && o && kx.remove(o.nextSibling), !e.inline && r && (i = e, kx.setStyle(i.id, "display", i.orgDisplay)), Kg(e), e.editorManager.remove(e), kx.remove(e.getContainer()), Tx(t), Tx(n), e.destroy()
            }
            var i
        },
        _x = function (e, t) {
        ...
        Lx = function (e, t, n) {
            ...
            r = l, o = e, i = f, a = n.defaultSettings, u = t, c = {
                ...
                ie7_compat: !0
            }, t = gf(uf, c, a, u), l.settings = t, Ci.language = t.language || "en", Ci.languageLoad = t.language_load, Ci.baseURL = n.baseURL, l.id = e, l.setDirty(!1), l.plugins = {}, l.documentBaseURI = new yx(t.document_base_url, {
                base_uri: d
            }), l.baseURI = d, l.contentCSS = [], l.contentStyles = [], l.shortcuts = new fp(l), l.loadedCSS = {}, l.editorCommands = new zg(l), l.suffix = n.suffix, l.editorManager = n, l.inline = t.inline, l.buttons = {}, l.menuItems = {}, t.cache_suffix && (fe.cacheSuffix = t.cache_suffix.replace(/^[\?\&]+/, "")), !1 === t.override_viewport && (fe.overrideViewPort = !1), n.fire("SetupEditor", {
                editor: l
    ...
    var Ix, Mx, Fx, zx = {
        ...
        $x = function (r, e) {
            ...
            Vx(t), t.on("focusin", function () {
                ...
                t = e.target, n && t.ownerDocument === document && (t === document.body || qx(n, t) || r.focusedEditor !== n || (n.fire("blur", {
                    focusedEditor: null
                }), r.focusedEditor = null))
    ...
    ew(Fx = {
        ...
        setup: function () {
            var e, t, n, r, o = "";
            if (t = yx.getDocumentBaseUrl(document.location), /^[^:]+:\/\/\/?[^\/]+\//.test(t) && (t = t.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, ""), /[\/\\]$/.test(t) || (t += "/")), n = window.tinymce || window.tinyMCEPreInit) e = n.base || n.baseURL, o = n.suffix;
            else {
        ...
        add: function (e) {
            var t = this;
            return rw[e.id] === e || (null === t.get(e.id) && ("length" !== e.id && (rw[e.id] = e), rw.push(e), ow.push(e)), aw(!0), t.activeEditor = e, t.fire("AddEditor", {
                editor: e
            }), Mx || (Mx = function () {
                t.fire("BeforeUnload")
        ...
        remove: function (e) {
            var t, n, r = this;
            if (e) {
                if (!T(e)) return n = e, D(r.get(n.id)) ? null : (uw(n) && r.fire("RemoveEditor", {
                    editor: n
                }), 0 === ow.length && Jx.unbind(window, "beforeunload", Mx), n.remove(), aw(0 < ow.length), n);
                Zx(Jx.select(e), function (e) {
                    (n = r.get(e.id)) && r.remove(n)
                })
            } else
                for (t = ow.length - 1; 0 <= t; t--) r.remove(ow[t])
        },
        ...
        yw = {
            ...
            findBestRelativePosition: function (e, t, n, r) {
                ...
                for (i = 0; i < r.length; i++)
                    if ((o = vw(e, t, r[i])).x >= n.x && o.x + o.w <= n.w + n.x && o.y >= n.y && o.y + o.h <= n.h + n.y) return r[i];
                return null
            },
    ...
    Ew.extend = fw = function (n) {
        var e, t, r, o = this.prototype,
            i = function () {
                var e, t, n;
                if (!dw && (this.init && this.init.apply(this, arguments), t = this.Mixins))
    ...
    var Sw = Math.min,
        ...
        Dw = {
            send: function (e) {
                ...
                if (e.scope = e.scope || this, e.success_scope = e.success_scope || e.scope, e.error_scope = e.error_scope || e.scope, e.async = !1 !== e.async, e.data = e.data || "", Dw.fire("beforeInitialize", {
                        settings: e
                    }), t = Hp()) {
    ...
    Fw = Vw, window.tinymce = Fw, window.tinyMCE = Fw,
        function (e) {
