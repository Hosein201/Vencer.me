...
! function (n) {
    ...
    var i = "bootstrapDualListbox",
        n = {
            ...
            moveSelectedLabel: "حرکت انتخاب شده ها",
            moveAllLabel: "حرکت همه",
            removeSelectedLabel: "حذف انتخاب شده ها",
            ...
            nonSelectedFilter: "",
            selectedFilter: "",
            infoText: "نمایش همه {0}",
            infoTextFiltered: '<span class="badge badge-warning">فیلتر شده ها</span> {0} از {1}',
            infoTextEmpty: "لیست خالی",
            filterOnValues: !1,
            sortByInputOrder: !1,
            eventMoveOverride: !1,
