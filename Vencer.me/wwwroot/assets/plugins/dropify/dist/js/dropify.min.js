    ...
    function i(i, t) {
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                messages: {
                    "default": "فایل خود را کشیده و اینجا رها کنید یا کلیک کنید",
                    replace: "برای جایگزینی کشیده و رها کنید یا کلیک کنید",
                    remove: "حذف",
                ...
                error: {
                    ...
                    fileExtension: "پسوند فایل مجاز نمی باشد ({{ value }} فقط)"
                },
                tpl: {
