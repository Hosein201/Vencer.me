...
! function (t, e) {
    ...
    return function (t) {
        ...
        e.populateInstanceComputableOptions = i, e.datepickerLocale = r, e.locale = o, e.getMomentLocaleData = s, o("fa", d.englishDefaults)
    }, function (t, e, n) {
        function i(t) {
        ...
        var Ee = t.langs = {};
        t.datepickerLang = function (e, n, i) {
            var r = Ee[e] || (Ee[e] = {});
        ...
        function i(t) {
            return "fa" !== t.locale() ? t.clone().locale("fa") : t
        }
