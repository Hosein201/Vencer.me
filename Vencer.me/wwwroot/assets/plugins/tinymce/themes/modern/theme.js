  ...
  var modern = (function () {
    ...
    var render = function (editor, theme, args) {
      ...
      if (hasStatusbar(editor)) {
        var linkHtml = '<a href="#" rel="noopener" target="_blank" role="presentation" tabindex="-1"></a>';
    ...
    var proto$1 = {
      ...
      layoutRect: function (newRect) {
        ...
        var curRect = self$$1._layoutRect,
          lastLayoutRect, size, deltaWidth, deltaHeight, repaintControls;
        if (!curRect) {
    ...
    function addRemove(add, ctrl) {
      var i, zIndex = FloatPanel.zIndex || 65535,
        topModal;
      if (add) {
        zOrder.push(ctrl);
      } else {
    ...
    var TextBox = Widget.extend({
      ...
      repaint: function () {
        var self$$1 = this;
        var style, rect, borderBox, borderW, borderH = 0,
          lastRepaintRect;
        style = self$$1.getEl().style;
        rect = self$$1._layoutRect;
        lastRepaintRect = self$$1._lastRepaintRect || {};
