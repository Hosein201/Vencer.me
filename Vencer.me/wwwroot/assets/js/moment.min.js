...
! function (a, b) {
    ...
    function Vb(a, b, c) {
        return a > 11 ? c ? "عصر" : "عصر" : c ? "صبح" : "صبح"
    }
    ...
    var md = "ژانویه_فوریه_مارس_آپریل_می_ژوئن_جولای_آگوست_سپتامبر_اکتبر_نوامبر_دسامبر".split("_"),
        nd = "ژانویه_فوریه_مارس_آپریل_می_ژوئن_جولای_آگوست_سپتامبر_اکتبر_نوامبر_دسامبر".split("_"),
        od = {};
    ...
    var Ed = "یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنج شنبه_جمعه_شنبه".split("_"),
        Fd = "یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنج شنبه_جمعه_شنبه".split("_"),
        Gd = "یک_دو_سه_چهار_پنج_جمعه_شنبه".split("_");
