! function () {
    ...
    var e, t, n, i, r, o = tinymce.util.Tools.resolve("tinymce.ThemeManager"),
            ...
            var i, o = function () {
                ...
                n = function (e, t) {
                    ...
                    if (!x.removed) {
                        ...
                        var c, d, f, h, m;
                        l = ["bc-tc", "tc-bc", "tl-bl", "bl-tl", "tr-br", "br-tr"], s = e.toolbar.panel, t && s.show(), d = e.element, f = z.getPos(x.getContentAreaContainer()), h = x.dom.getRect(d), "BODY" === (m = x.dom.getRoot()).nodeName && (h.x -= m.ownerDocument.documentElement.scrollLeft || m.scrollLeft, h.y -= m.ownerDocument.documentElement.scrollTop || m.scrollTop), h.x += f.x, h.y += f.y, r = h, i = z.getRect(s.getEl()), o = z.getRect(x.getContentAreaContainer() || x.getBody());
                        var g, p, v, b = O.getUiContainerDelta(s).getOr({
                            x: 0,
                            y: 0
                        });
                        if (r.x += b.x, r.y += b.y, i.x += b.x, i.y += b.y, o.x += b.x, o.y += b.y, "inline" !== z.getStyle(e.element, "display", !0)) {
                            var y = e.element.getBoundingClientRect();
                            r.w = y.width, r.h = y.height
                        }
                        x.inline || (o.w = x.getDoc().documentElement.offsetWidth), x.selection.controlSelection.isResizable(e.element) && r.w < 25 && (r = C.inflate(r, 0, 8)), n = C.findBestRelativePosition(i, r, o, l), r = C.clamp(r, o), n ? (a = C.relativePosition(i, r, n), F(s, U(u, a.x, a.y, r, o, i))) : (o.h += i.h, (r = C.intersect(o, r)) ? (n = C.findBestRelativePosition(i, r, o, ["bc-tc", "bl-tl", "br-tr"])) ? (a = C.relativePosition(i, r, n), F(s, U(u, a.x, a.y, r, o, i))) : F(s, U(u, r.x, r.y, r, o, i)) : s.hide()), g = s, v = function (e, t) {
                            return e === t
                    ...
                    t = b.create({
                        ...
                        function (e) {
                            if (!i) {
                                ...
                                i = x.selection.getScrollContainer() || x.getWin(), z.bind(i, "scroll", t), z.bind(n, "scroll", t), x.on("remove", function () {
        ...
        $ = Y("function"),
        q = Y("number"),
        X = (r = Array.prototype.indexOf) === undefined ? function (e, t) {
            return Q(e, t)
        } : function (e, t) {
            return r.call(e, t)
        },
        ...
        te = (Array.prototype.slice, $(Array.from) && Array.from, {
            file: {
                title: "فایل",
        ...
        re = function (n, e, t, i) {
            ...
            return e ? (o = e[i], a = !0) : o = te[i], o && (r = {
                ...
                var n;
                e.context !== i || (n = t, Z(s, function (e) {
                    return e.name === n
                ...
                }), e.prependToContext ? s.unshift(ne(t, e)) : s.push(ne(t, e)), "after" === e.separator && s.push({
                    name: "|",
                    item: {
                        text: "|"
                    }
        ...
        he = function (c, d, f) {
            return function (e) {
                ...
                i = d, r = a, o = f, w.each(o, function (e) {
                    ...
                    t && t.visible() && e.name !== i && (fe(e, t, "onhide"), t.visible(!1))
                }), s.parent().items().each(function (e) {
                    e.active(!1)
                }), l && l.visible() ? (fe(u, l, "onhide"), l.hide(), s.active(!1)) : (l ? l.show() : (l = b.create({
                    type: "container",
                    name: d,
                    layout: "stack",
                    classes: "sidebar-panel",
                    html: ""
                }), a.prepend(l), fe(u, l, "onrender")), fe(u, l, "onshow"), s.active(!0)), x(c)
            }
        },
        me = function (e) {
            return !(de.ie && !(11 <= de.ie) || !e.sidebars) && 0 < e.sidebars.length
        },
        ge = function (n) {
            return {
                type: "panel",
        ...
        ye = function (t, e, n) {
            var i, r, o, s, a;
            if (!1 === g(t) && n.skinUiCss ? ve.styleSheetLoader.load(n.skinUiCss, pe(t)) : pe(t)(), i = e.panel = b.create({
                    type: "panel",
                    role: "application",
                    classes: "tinymce",
                    ...
                    onResize: function (e) {
                        "both" === p(t) ? ue(t, o.width + e.deltaX, o.height + e.deltaY) : ue(t, null, o.height + e.deltaY)
                    }
                }), t.getParam("statusbar", !0, "boolean")) {
                var l = y.translate(["{0}", '<a href="#" rel="noopener" target="_blank" role="presentation" tabindex="-1"></a>']),
            ...
            })), i.renderBefore(n.targetNode).reflow(), t.getParam("readonly", !1, "boolean") && t.setMode("readonly"), n.width && ve.setStyle(i.getEl(), "width", n.width), t.on("remove", function () {
                i.remove(), i = null
            }), R(t, i), V(t), {
    ...
    function Ee(e, t, n) {
        ...
        return d = ke(), o = (r = _e.getPos(t, O.getUiContainer(e))).x, s = r.y, Ce(e) && Re(document.body) && (o -= d.x, s -= d.y), i = e.getEl(), a = (f = _e.getSize(i)).width, l = f.height, u = (f = _e.getSize(t)).width, c = f.height, "b" === (n = (n || "").split(""))[0] && (s += c), "r" === n[1] && (o += u), "c" === n[0] && (s += Math.round(c / 2)), "c" === n[1] && (o += Math.round(u / 2)), "b" === n[3] && (s -= l), "r" === n[4] && (o -= a), "c" === n[3] && (s -= Math.round(l / 2)), "c" === n[4] && (o -= Math.round(a / 2)), {
            x: o,
            y: s,
            w: a,
            h: l
    ...
    var ke = function () {
            var e = window;
            return {
                x: Math.max(e.pageXOffset, document.body.scrollLeft, document.documentElement.scrollLeft),
                y: Math.max(e.pageYOffset, document.body.scrollTop, document.documentElement.scrollTop),
        ...
        Se = {
            ...
            moveTo: function (e, t) {
                ...
                return s && Re(s) && !Ce(n) && (e -= s.scrollLeft, t -= s.scrollTop), s && (e += 1, t += 1), n.state.get("rendered") ? n.layoutRect({
                    x: e,
                    y: t
        ...
        Fe = Te.extend({
            init: function (e) {
                ...
                function s(e, t, n) {
                    ...
                    }((i = Le.exec(e.replace(Ie, "")))[1])), r(function (t) {
    ...
    Be = {
        ...
        add: function (e) {
            return w.isArray(e) ? Ue.apply(this, e) : e instanceof Ae ? this.add(e.toArray()) : Ue.call(this, e), this
        },
        set: function (e) {
            var t, n = this,
                i = n.length;
        ...
        filter: function (t) {
            var e, n, i, r, o = [];
            for ("string" == typeof t ? (t = new Fe(t), r = function (e) {
                    return t.match(e)
    ...
    var je, Je, Ge = Te.extend({
            Mixins: [qe],
            init: function (e) {
                var t, n;
                for (t in e = e || {})(n = e[t]) instanceof $e && (e[t] = n.create(this, t));
                this.data = e
            },
            set: function (t, n) {
        ...
        Ze = {
            add: function (e) {
                ...
                if (t) {
                    ...
                    Ke[t._id] || (Ke[t._id] = t), je || (je = !0, u.requestAnimationFrame(function () {
                        var e, t;
                        for (e in je = !1, Ke)(t = Ke[e]).state.get("rendered") && t.reflow();
                        Ke = {}
                    }, document.body))
                }
            },
        ...
        nt = {
            ...
            init: function (t) {
                ...
                i.settings = t = w.extend({}, i.Defaults, t), i._id = t.id || "mceu_" + tt++, i._aria = {
                    role: t.role
                }, i._elmCache = {}, i.$ = xe, i.state = new Ge({
                    visible: !0,
                    active: !1,
                    disabled: !1,
                    value: ""
                }), i.data = new Ge(t.data), i.classes = new De(function () {
            ...
            initLayoutRect: function () {
                var e, t, n, i, r, o, s, a, l, u, c = this,
                    d = c.settings,
                    f = c.getEl();
                e = c.borderBox = c.borderBox || Pe(f, "border"), c.paddingBox = c.paddingBox || Pe(f, "padding"), c.marginBox = c.marginBox || Pe(f, "margin"), u = _e.getSize(f), a = d.minWidth, l = d.minHeight, r = a || u.width, o = l || u.height, n = d.width, i = d.height, s = void 0 !== (s = d.autoResize) ? s : !n && !i, n = n || r, i = i || o;
            ...
            updateLayoutRect: function () {
                var e = this;
                e.parent()._lastRect = null, _e.css(e.getEl(), {
                    width: "",
                    height: ""
            ...
            on: function (e, t) {
                var n, i, r, o = this;
                return it(o).on(e, "string" != typeof (n = t) ? n : function (e) {
            ...
            fire: function (e, t, n) {
                if ((t = t || {}).control || (t.control = this), t = it(this).fire(e, t), !1 !== n && this.parent)
            ...
            getEl: function (e) {
                ...
                return this._elmCache[t] || (this._elmCache[t] = xe("#" + t)[0]), this._elmCache[t]
            },
            show: function () {
            ...
            remove: function () {
                ...
                r && r.items && (t = [], r.items().each(function (e) {
                    e !== n && t.push(e)
                }), r.items().set(t), r._lastRect = null), n._eventsRoot && n._eventsRoot === n && xe(i).off();
            ...
            renderTo: function (e) {
                return xe(e || this.getContainerElm()).append(this.renderHtml()), this.postRender(), this
            },
            preRender: function () {},
            render: function () {},
            renderHtml: function () {
            ...
            postRender: function () {
                var e, t, n, i, r, o = this,
                    s = o.settings;
                for (i in o.$el = xe(o.getEl()), o.state.set("rendered", !0), s) 0 === i.indexOf("on") && o.on(i.substr(2), s[i]);
                if (o._eventsRoot) {
                    for (n = o.parent(); !r && n; n = n.parent()) r = n._eventsRoot;
                    if (r)
                        for (i in r._nativeEvents) o._nativeEvents[i] = !0
                }
                rt(o), s.style && (e = o.getEl()) && (e.setAttribute("style", s.style), e.style.cssText = s.style), o.settings.border && (t = o.borderBox, o.$el.css({
                ...
                !1 === o.state.get("visible") && (o.getEl().style.display = "none"), o.bindStates(), o.state.on("change:visible", function (e) {
                    var t, n = e.value;
                    o.state.get("rendered") && (o.getEl().style.display = !1 === n ? "none" : "", o.getEl().getBoundingClientRect()), (t = o.parent()) && (t._lastRect = null), o.fire(n ? "show" : "hide"), Ze.add(o)
                }), o.fire("postrender", {}, !1)
            },
            bindStates: function () {},
    ...
    function it(n) {
        return n._eventDispatcher || (n._eventDispatcher = new Me({
            scope: n,
            toggleEvent: function (e, t) {
                t && Me.isNative(e) && (n._nativeEvents || (n._nativeEvents = {}), n._nativeEvents[e] = !0, n.state.get("rendered") && rt(n))
            }
        })), n._eventDispatcher
    }
    ...
    function rt(a) {
        ...
        if (i = a._nativeEvents) {
            ...
            for (r in d || (d = l._delegates = {}), i) {
                if (!i) return !1;
                "wheel" !== r || et ? ("mouseenter" === r || "mouseleave" === r ? l._hasMouseEnter || (xe(l.getEl()).on("mouseleave", s).on("mouseover", u), l._hasMouseEnter = 1) : d[r] || (xe(l.getEl()).on(r, o), d[r] = !0), i[r] = !1) : Qe ? xe(a.getEl()).on("mousewheel", c) : xe(a.getEl()).on("DOMMouseScroll", c)
            }
        }
    }
    ...
    function at(e) {
        ...
        function c(t) {
            ...
            return function e(t) {
                if (1 === t.nodeType && "none" !== t.style.display && !t.disabled) {
                    var n;
                    (u(n = t) && !n.hidden || st(n) || /^(button|menuitem|checkbox|tab|menuitemcheckbox|option|gridcell|slider)$/.test(s(n))) && r.push(t);
        ...
        return r = n.getParentCtrl(o), n.on("keydown", function (e) {
            function t(e, t) {
                u(o) || st(o) || "slider" !== s(o) && !1 !== t(e) && e.preventDefault()
            }
    ...
    var lt = {},
        ut = ot.extend({
            init: function (e) {
                var t = this;
                t._super(e), (e = t.settings).fixed && t.state.set("fixed", !0), t._items = new Ye, t.isRtl() && t.classes.add("rtl"), t.bodyClasses = new De(function () {
            ...
            create: function (e) {
                ...
                return w.isArray(e) || (e = [e]), w.each(e, function (e) {
                    e && (e instanceof ot || ("string" == typeof e && (e = {
                        type: e
            ...
            renderNew: function () {
                ...
                return i.items().each(function (e, t) {
                    var n;
                    e.parent(i), e.state.get("rendered") || ((n = i.getEl("body")).hasChildNodes() && t <= n.childNodes.length - 1 ? xe(n.childNodes[t]).before(e.renderHtml()) : xe(n).append(e.renderHtml()), e.postRender(), Ze.add(e))
            ...
            reflow: function () {
                ...
                if (Ze.remove(this), this.visible()) {
                    for (ot.repaintControls = [], ot.repaintControls.map = {}, this.recalc(), e = ot.repaintControls.length; e--;) ot.repaintControls[e].repaint();
                    "flow" !== this.settings.layout && "stack" !== this.settings.layout && this.repaint(), ot.repaintControls = []
                }
                return this
            }
        });
    ...
    function dt(e, h) {
        ...
        t = function (e) {
            ...
            ct(e), e.preventDefault(), g = e.button, c = w, b = e.screenX, y = e.screenY, d = window.getComputedStyle ? window.getComputedStyle(c, null).getPropertyValue("cursor") : c.runtimeStyle.cursor, m = xe("<div></div>").css({
                position: "absolute",
                top: 0,
                left: 0,
                width: f.width,
                ...
                opacity: 1e-4,
                cursor: d
            }).appendTo(x.body), xe(x).on("mousemove touchmove", v).on("mouseup touchend", p), h.start(e)
        }, v = function (e) {
            if (ct(e), e.button !== g) return p(e);
            e.deltaX = e.screenX - b, e.deltaY = e.screenY - y, e.preventDefault(), h.drag(e)
        }, p = function (e) {
            ct(e), xe(x).off("mousemove touchmove", v).off("mouseup touchend", p), m.remove(), h.stop && h.stop(e)
                ...
                function n() {
                    ...
                    function t(e, t, n, i, r, o) {
                        ...
                        if (a = p.getEl("scroll" + e)) {
                            if (f = t.toLowerCase(), h = n.toLowerCase(), xe(p.getEl("absend")).css(f, p.layoutRect()[i] - 1), !r) return void xe(a).css("display", "none");
                            xe(a).css("display", "block"), s = p.getEl("body"), l = p.getEl("scroll" + e + "t"), u = s["client" + n] - 2 * v, c = (u -= m && g ? a["client" + o] : 0) / s["scroll" + n], (d = {})[f] = s["offset" + t] + v, d[h] = u, xe(a).css(d), (d = {})[f] = s["scroll" + t] * c, d[h] = u * c, xe(l).css(d)
                        }
                    }
                ...
                p.settings.autoScroll && (p._hasScroll || (p._hasScroll = !0, function () {
                    function e(s, a, l, u, c) {
                        var d, e = p._id + "-scroll" + s,
                            t = p.classPrefix;
                        xe(p.getEl()).append('<div id="' + e + '" class="' + t + "scrollbar " + t + "scrollbar-" + s + '"><div id="' + e + 't" class="' + t + 'scrollbar-thumb"></div></div>'), p.draghelper = new dt(e + "t", {
                            start: function () {
                                d = p.getEl("body")["scroll" + a], xe("#" + e).addClass(t + "active")
                            },
                            drag: function (e) {
    ...
    function Rt(r) {
        ...
        function t(e, t) {
            for (var n, i = 0; i < yt.length; i++)
                if (yt[i] !== r)
                    for (n = yt[i].parent(); n && (n = n.parent());) n === r && yt[i].fixed(e).moveBy(0, t).repaint()
        }
    ...
    function Ct(e, t) {
        var n, i, r = Et.zIndex || 65535;
        if (e) xt.push(t);
        else
            for (n = xt.length; n--;) xt[n] === t && xt.splice(n, 1);
        if (xt.length)
            for (n = 0; n < xt.length; n++) xt[n].modal && (r++, i = xt[n]), xt[n].getEl().style.zIndex = r, xt[n].zIndex = r, r++;
        var o = xe("#" + t.classPrefix + "modal-block", t.getContainerElm())[0];
        i ? xe(o).css("z-index", i.zIndex - 1) : o && (o.parentNode.removeChild(o), gt = !1), Et.currentZIndex = r
    }
    var Et = vt.extend({
        Mixins: [Se, bt],
        init: function (e) {
            var i = this;
            i._super(e), (i._eventsRoot = i).classes.add("floatpanel"), e.autohide && (_t(), function () {
                if (!mt) {
                    var e = document.documentElement,
                        t = e.clientWidth,
                        n = e.clientHeight;
                    mt = function () {
                        document.all && t === e.clientWidth && n === e.clientHeight || (t = e.clientWidth, n = e.clientHeight, Et.hideAll())
                    }, xe(window).on("resize", mt)
                }
            }(), yt.push(i)), e.autofix && (ht || (ht = function () {
                var e;
                for (e = yt.length; e--;) Rt(yt[e])
            }, xe(window).on("scroll", ht)), i.on("move", function () {
                Rt(this)
            })), i.on("postrender show", function (e) {
                if (e.control === i) {
                    var t, n = i.classPrefix;
                    i.modal && !gt && ((t = xe("#" + n + "modal-block", i.getContainerElm()))[0] || (t = xe('<div id="' + n + 'modal-block" class="' + n + "reset " + n + 'fade"></div>').appendTo(i.getContainerElm())), u.setTimeout(function () {
        ...
        close: function () {
            return this.fire("close").isDefaultPrevented() || (this.remove(), Ct(!1, this)), this
        },
        remove: function () {
            kt(this), this._super()
        },
    ...
    var Ht = function (s, n, e) {
        ...
        var r = function () {
            ...
            u = function () {
                a && (a.hide(), Et.hideAll(), l.removeClass(s.getBody(), "mce-edit-focus"))
            },
            c = function () {
                var e, t;
                ...
                }), O.setUiContainer(s, a), _(s), i ? a.renderTo(i).reflow() : a.renderTo().reflow(), R(s, a), o(), V(s), s.on("nodeChange", r), s.on("ResizeWindow", r), s.on("activate", o), s.on("deactivate", u), s.nodeChanged())
            };
        return s.settings.content_editable = !0, s.on("focus", function () {
            ...
            a && (a.remove(), a = null)
        }), !1 === g(s) && e.skinUiCss ? l.styleSheetLoader.load(e.skinUiCss, pe(s)) : pe(s)(), {}
    };
    ...
    function St(i, r) {
        ...
        a.show = function (e, t) {
            function n() {
                o && (xe(i).append('<div class="' + l + "throbber" + (r ? " " + l + "throbber-inline" : "") + '"></div>'), t && t())
            }
    ...
    var Tt = function (e, t) {
            ...
            e.on("ProgressState", function (e) {
                n = n || new St(t.panel.getEl("body")), e.state ? n.show(e.time) : n.hide()
            })
        },
        Mt = function (e, t, n) {
            var i = function (e) {
            ...
            return i && (n.skinUiCss = i + "/skin.min.css", e.contentCSS.push(i + "/content" + (e.inline ? ".inline" : "") + ".min.css")), Tt(e, t), e.getParam("inline", !1, "boolean") ? Ht(e, t, n) : ye(e, t, n)
        },
        Nt = ot.extend({
            Mixins: [Se],
            Defaults: {
        ...
        Pt = ot.extend({
            init: function (i) {
                var r = this;
                r._super(i), i = r.settings, r.canFocus = !0, i.tooltip && !1 !== Pt.tooltips && (r.on("mouseenter", function (e) {
            ...
            tooltip: function () {
                return this._tooltip || (this._tooltip = new Nt({
                    type: "tooltip"
        ...
        Ot = ot.extend({
            ...
            init: function (e) {
                var t = this;
                t._super(e), t.maxWidth = e.maxWidth, e.text && t.text(e.text), e.icon && (t.icon = e.icon), e.color && (t.color = e.color), e.type && t.classes.add("notification-" + e.type), e.timeout && (e.timeout < 0 || 0 < e.timeout) && !e.closeButton ? t.closeButton = !1 : (t.classes.add("has-close"), t.closeButton = !0), e.progressBar && (t.progressBar = new Wt), t.on("click", function (e) {
    ...
    function At(o) {
        ...
        return {
            open: function (e, t) {
                var n, i = w.extend(e, {
                        maxWidth: (n = s(o), _e.getSize(n).width)
                    }),
                    r = new Ot(i);
    ...
    function zt(e) {
        var t, n = xe("meta[name=viewport]")[0];
        !1 !== de.overrideViewPort && (n || ((n = document.createElement("meta")).setAttribute("name", "viewport"), document.getElementsByTagName("head")[0].appendChild(n)), (t = n.getAttribute("content")) && void 0 !== Lt && (Lt = t), n.setAttribute("content", e ? "width=device-width,initial-scale=1.0,user-scalable=0,minimum-scale=1.0,maximum-scale=1.0" : Lt))
    }

    function It(e, t) {
        (function () {
            for (var e = 0; e < Bt.length; e++)
                if (Bt[e]._fullscreen) return !0;
            return !1
        })() && !1 === t && xe([document.documentElement, document.body]).removeClass(e + "fullscreen")
    }
    var Ft = Et.extend({
        modal: !0,
        Defaults: {
        ...
        init: function (e) {
            var n = this;
            n._super(e), n.isRtl() && n.classes.add("rtl"), n.classes.add("window"), n.bodyClasses.add("window-body"), n.state.set("fixed", !0), e.buttons && (n.statusbar = new vt({
                layout: "flex",
                border: "1 0 0 0",
                spacing: 3,
                padding: 10,
                ...
                (_e.hasClass(e.target, t) || _e.hasClass(e.target.parentNode, t)) && n.close()
        ...
        recalc: function () {
            var e, t, n, i, r = this,
                o = r.statusbar;
            r._fullscreen && (r.layoutRect(_e.getWindowSize()), r.layoutRect().contentH = r.layoutRect().innerH), r._super(), e = r.layoutRect(), r.settings.title && !r._fullscreen && (t = e.headerW) > e.w && (n = e.x - Math.max(0, t / 2), r.layoutRect({
                w: t,
                x: n
            }), i = !0), o && (o.layoutRect({
        ...
        fullscreen: function (e) {
            var n, t, i = this,
                ...
                o = i.classPrefix;
            if (e !== i._fullscreen)
                if (xe(window).on("resize", function () {
                        var e;
                        if (i._fullscreen)
                    ...
                    i._initial = {
                        ...
                        w: t.w,
                        h: t.h
                    }, i.borderBox = Ne("0"), i.getEl("head").style.display = "none", t.deltaH -= t.headerH + 2, xe([r, document.body]).addClass(o + "fullscreen"), i.classes.add("fullscreen");
                    var s = _e.getWindowSize();
                    i.moveTo(0, 0).resizeTo(s.w, s.h)
                } else i.borderBox = Ne(i.settings.border), i.getEl("head").style.display = "", t.deltaH += t.headerH, xe([r, document.body]).removeClass(o + "fullscreen"), i.classes.remove("fullscreen"), i.moveTo(i._initial.x, i._initial.y).resizeTo(i._initial.w, i._initial.h);
            return i.reflow()
        },
        postRender: function () {
            var t, n = this;
            ...
            }, 0), n._super(), n.statusbar && n.statusbar.postRender(), n.focus(), this.dragHelper = new dt(n._id + "-dragh", {
                start: function () {
                    t = {
                        x: n.layoutRect().x,
                        y: n.layoutRect().y
        ...
        remove: function () {
            var e, t = this;
            for (t.dragHelper.destroy(), t._super(), t.statusbar && this.statusbar.remove(), It(t.classPrefix, !1), e = Bt.length; e--;) Bt[e] === t && Bt.splice(e, 1);
            zt(0 < Bt.length)
        },
        ...
        if (!de.desktop) {
            ...
            u.setInterval(function () {
                ...
                n.w === e && n.h === t || (n = {
                    w: e,
                    h: t
                }, xe(window).trigger("resize"))
            }, 100)
        }
        xe(window).on("resize", function () {
            var e, t, n = _e.getWindowSize();
            for (e = 0; e < Bt.length; e++) t = Bt[e].layoutRect(), Bt[e].moveTo(Bt[e].settings.x || Math.max(0, n.w / 2 - t.w / 2), Bt[e].settings.y || Math.max(0, n.h / 2 - t.h / 2))
        })
    }();
    var Ut, Vt, Yt, $t = Ft.extend({
            init: function (e) {
                e = {
                    border: 1,
                    padding: 20,
        ...
        Gt = Jt.extend({
            ...
            postRender: function () {
                ...
                n._super(), xe(t).on("change", function (e) {
            ...
            remove: function () {
                xe(this.getEl("button")).off(), xe(this.getEl("input")).off(), this._super()
            }
        }),
        Kt = ut.extend({
            Defaults: {
        ...
        en = Pt.extend({
            ...
            repaint: function () {
                var e, t, n = this,
                    ...
                    s = 0,
                    a = i.firstChild;
                n.statusLevel() && "none" !== n.statusLevel() && (s = parseInt(_e.getRuntimeStyle(a, "padding-right"), 10) - parseInt(_e.getRuntimeStyle(a, "padding-left"), 10)), e = r ? o.w - _e.getSize(r).width - 10 : o.w - 10;
                var l = document;
                return l.all && (!l.documentMode || l.documentMode <= 8) && (t = n.layoutRect().h - 2 + "px"), xe(a).css({
                    width: e - s,
                    lineHeight: t
                }), n._super(), n
            },
            postRender: function () {
                var t = this;
                return xe(this.getEl("inp")).on("change", function (e) {
            ...
            bindStates: function () {
                ...
                r.state.on("change:value", function (e) {
                    ...
                    var t = r.getEl("status"),
                        n = r.classPrefix,
                        i = e.value;
                    _e.css(t, "display", "none" === i ? "none" : ""), _e.toggleClass(t, n + "i-checkmark", "ok" === i), _e.toggleClass(t, n + "i-warning", "warn" === i), _e.toggleClass(t, n + "i-error", "error" === i), r.classes.toggle("has-status", "none" !== i), r.repaint()
                ...
                return r.on("keydown", function (e) {
                    var t = e.keyCode;
                    "INPUT" === e.target.nodeName && (t === Qt.DOWN ? (e.preventDefault(), r.fire("autocomplete"), n(0, r.menu)) : t === Qt.UP && (e.preventDefault(), n(-1, r.menu)))
                }), r._super()
            },
            remove: function () {
                xe(this.getEl("inp")).off(), this.menu && this.menu.remove(), this._super()
            }
        }),
        tn = en.extend({
            init: function (e) {
            ...
            showPanel: function () {
                ...
                if (t.classes.add("opened"), t.panel) t.panel.show();
                    ...
                    n.type && (n = {
                        layout: "grid",
                        items: n
                    }), n.role = n.role || "dialog", n.popover = !0, n.autohide = !0, n.ariaRoot = !0, t.panel = new Et(n).on("hide", function () {
        ...
        on = nn.extend({
            ...
            postRender: function () {
                ...
                return t.on("click", function (e) {
                    e.aria && "down" === e.aria.key || e.control !== t || rn.getParent(e.target, "." + t.classPrefix + "open") || (e.stopImmediatePropagation(), n.call(t, e))
        ...
        an = Pt.extend({
            ...
            postRender: function () {
                ...
                i = a.getEl("h"), r = a.getEl("hp"), o = a.getEl("sv"), s = a.getEl("svp"), a._repaint = function () {
                    c(n = l.toHsv())
                }, a._super(), a._svdraghelper = new dt(a._id + "-sv", {
                    start: e,
                    drag: e
                }), a._hdraghelper = new dt(a._id + "-h", {
                    start: t,
                    drag: t
                }), a._repaint()
            },
        ...
        ln = Pt.extend({
            ...
            renderHtml: function () {
                ...
                return e = {
                    id: this._id,
                    hidefocus: "1"
                }, t = _e.create("div", e, "<span>" + this.translate(n.text) + "</span>"), n.height && _e.css(t, "height", n.height + "px"), n.width && _e.css(t, "width", n.width + "px"), t.className = this.classes, t.outerHTML
            },
            postRender: function () {
                var i = this,
                    e = function (e) {
        ...
        vn = (Node.ATTRIBUTE_NODE, Node.CDATA_SECTION_NODE, Node.COMMENT_NODE, Node.DOCUMENT_NODE),
        bn = (Node.DOCUMENT_TYPE_NODE, Node.DOCUMENT_FRAGMENT_NODE, Node.ELEMENT_NODE),
        yn = (Node.TEXT_NODE, Node.PROCESSING_INSTRUCTION_NODE, Node.ENTITY_REFERENCE_NODE, Node.ENTITY_NODE, Node.NOTATION_NODE, "undefined" != typeof window ? window : Function("return this;")(), function (e, t) {
            var n = function (e, t) {
        ...
        In = [{
            ...
            search: function (e) {
                return Bn(e, "edge/") && Bn(e, "chrome") && Bn(e, "safari") && Bn(e, "applewebkit")
            }
        }, {
            name: "Chrome",
        ...
        Vn = function (e) {
            var t, n, i, r, o, s, a, l, u, c, d, f = Un.browsers(),
                h = Un.oses(),
        ...
        qn = vn,
        Xn = function (e) {
            return e.nodeType !== $n && e.nodeType !== qn || 0 === e.childElementCount
        },
        jn = (Yn().browser.isIE(), function () {
            for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t]
        ...
        ei = function (e) {
            return e.id ? e.id : (t = "h", n = (new Date).getTime(), t + "_" + Math.floor(1e9 * Math.random()) + ++mn + String(n));
            var t, n
        },
        ti = function (e) {
        ...
        oi = function (e) {
            var t, n = ei(e);
            return Zn("header", Qn(e), "#" + n, ni(t = e) ? parseInt(t.nodeName.substr(1), 10) : 0, function () {
                e.id = n
            })
        },
        si = function (e) {
        ...
        ai = function (e) {
            var t, n, i, r, o, s;
            return t = "h1,h2,h3,h4,h5,h6,a:not([href])", n = e, J((Yn().browser.isIE(), function () {
                for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t]
            }("element", "offset"), i = pn.fromDom(n), r = t, s = (o = i) === undefined ? document : o.dom(), Xn(s) ? [] : J(s.querySelectorAll(r), pn.fromDom)), function (e) {
                return e.dom()
            })
        },
        li = function (e) {
        ...
        mi = function (e, i, r, t) {
            ...
            return !1 === t.typeahead_urls ? [] : "file" === r ? (n = [pi(e, d(ci)), pi(e, f("header")), pi(e, (a = f("anchor"), l = hi(t, "anchor_top", "#top"), u = hi(t, "anchor_bottom", "#bottom"), null !== l && a.unshift(fi("<top>", l)), null !== u && a.push(fi("<bottom>", u)), a))], o = function (e, t) {
        ...
        gi = function (e, t) {
            var n, i, r, o = ci[t];
            /^https?/.test(e) && (o ? (n = o, i = e, r = X(n, i), -1 === r ? W.none() : W.some(r)).isNone() && (ci[t] = o.slice(0, 5).concat(e)) : ci[t] = [e])
        },
        pi = function (e, t) {
            var n = e.toLowerCase(),
        ...
        _i = function (e, t) {
            return n = t, r = (i = e) === undefined ? document : i.dom(), Xn(r) ? W.none() : W.from(r.querySelector(n)).map(pn.fromDom);
            var n, i, r
        },
        Ri = function (e, t) {
            return function () {
        ...
        ki = function (i) {
            ...
            i.addMenuItem("align", {
                ...
                alignleft: ["چپ چین", "JustifyLeft"],
                aligncenter: ["وسط چین", "JustifyCenter"],
                alignright: ["راست چین", "JustifyRight"],
                alignjustify: ["هم تراز", "JustifyFull"],
                alignnone: ["بدون هم ترازی", "JustifyNone"]
            }, function (e, t) {
                i.addButton(t, {
                    active: !1,
                    tooltip: e[0],
                ...
                a.state.set("value", null), l.on("init nodeChange", function (e) {
                    var t, n, i, r, o = l.queryCommandValue("FontName"),
                        s = (t = u, r = (n = o) ? n.toLowerCase() : "", w.each(t, function (e) {
                            ...
                            i || Hi(e.value).toLowerCase() !== Hi(r).toLowerCase() || (i = e.value)
                        }), i);
                    ...
                    onPostRender: (s = n, a = t, function () {
                        ...
                        s.on("init nodeChange", function (e) {
                            ...
                            if (t = s.queryCommandValue("FontSize"))
                                for (i = 3; !r && 0 <= i; i--) n = Ni(t, i), r = Pi(a, n, t);
        ...
        Ai = function (n, e) {
            ...
            return e.items().each(function (e) {
                e.menu && e.visible(0 < Ai(n, e.menu)), !e.menu && e.settings.menu && e.visible(0 < Oi(n, e.settings.menu));
        ...
        Bi = function (e) {
            var i, r, o, t, s, n, a, l, u = (r = 0, o = [], t = [{
                ...
                itemDefaults: {
                    ...
                    onclick: function () {
                        this.settings.format && Ri(i, this.settings.format)(), this.settings.cmd && i.execCommand(this.settings.cmd)
                    }
                }
            });
        ...
        zi = function (e) {
            var t, n, i = function (e) {
                for (var t = (e = e.replace(/;$/, "").split(";")).length; t--;) e[t] = e[t].split("=");
                return e
            }(e.settings.block_formats || "پاراگراف=p;عنوان 1=h1;عنوان 2=h2;عنوان 3=h3;عنوان 4=h4;عنوان 5=h5;عنوان 6=h6;حالت زیبا=pre");
        ...
        Vi = function (e) {
            ...
            return Ui(o ? Ii(e, o) : (t = e, n = "insert", i = [{
                text: "-"
        ...
        $i = function (e) {
            ...
            n = e, w.each({
                ...
                subscript: "بزرگ نمایی",
                superscript: "کوچک نمایی"
            }, function (e, t) {
                n.addButton(t, {
                    active: !1,
                    tooltip: e,
                ...
                outdent: ["کاهش تورفتگی", "Outdent"],
                indent: ["افزایش تورفتگی", "Indent"],
                cut: ["برش", "Cut"],
                copy: ["کپی", "Copy"],
                paste: ["جای گذاری", "Paste"],
                help: ["راهنما", "mceHelp"],
                selectall: ["انتخاب همه", "SelectAll"],
                visualaid: ["حالت دیداری", "mceToggleVisualAid"],
                newdocument: ["سند جدید", "mceNewDocument"],
                removeformat: ["پاک کردن فرمت ها", "RemoveFormat"],
                remove: ["حذف", "Delete"]
            }, function (e, t) {
                i.addButton(t, {
                    tooltip: e[0],
        ...
        qi = function (e) {
            var n;
            $i(e), n = e, w.each({
                bold: ["بولد", "Bold", "Meta+B"],
                italic: ["ایتالیک", "Italic", "Meta+I"],
                underline: ["خط زیر", "Underline", "Meta+U"],
                strikethrough: ["خط خورده", "Strikethrough"],
                subscript: ["بزرگ نمایی", "Subscript"],
                superscript: ["کوچک نمایی", "Superscript"],
                removeformat: ["پاک کردن فرمت ها", "RemoveFormat"],
                newdocument: ["سند جدید", "mceNewDocument"],
                cut: ["برش", "Cut", "Meta+X"],
                copy: ["کپی", "Copy", "Meta+C"],
                paste: ["جای گذاری", "Paste", "Meta+V"],
                selectall: ["انتخاب همه", "SelectAll", "Meta+A"]
            }, function (e, t) {
                n.addMenuItem(t, {
                    text: e[0],
                    icon: t,
        ...
        Gi = {
            setup: function (e) {
                var t;
                e.rtl && (ot.rtl = !0), e.on("mousedown", function () {
                    Et.hideAll()
                }), (t = e).settings.ui_container && (de.container = _i(pn.fromDom(document.body), t.settings.ui_container).fold(k(null), function (e) {
                    return e.dom()
                })), Pt.tooltips = !de.iOS, ot.translate = function (e) {
                    return h.translate(e)
                }, zi(e), ki(e), qi(e), ji(e), Di(e), Mi(e), Bi(e), Ji(e), Yi(e)
            }
        },
        Ki = jt.extend({
            recalc: function (e) {
        ...
        er = Pt.extend({
            ...
            initLayoutRect: function () {
                var e = this,
                    t = e._super();
                return e.settings.multiline && (_e.getSize(e.getEl()).width > t.maxW && (t.minW = t.maxW, e.classes.add("multiline")), e.getEl().style.width = t.minW + "px", t.startMinH = t.h = t.minH = Math.min(t.maxH, _e.getSize(e.getEl()).height)), t
            },
            repaint: function () {
        ...
        ir = Jt.extend({
            ...
            postRender: function () {
                ...
                return r.on("click", function (e) {
                    ...
                    var t, n = e.control,
                        i = r.parent();
                    n && i && n instanceof ir && n.parent() === i && (i.items().filter("MenuButton").each(function (e) {
        ...
        rr = Et.extend({
            ...
            init: function (e) {
                ...
                this._super(e), this.classes.add("menu"), e.animate && 11 !== de.ie && this.classes.add("animate")
            },
            repaint: function () {
            ...
            load: function () {
                ...
                n.settings.itemsFactory && (n.throbber || (n.throbber = new St(n.getEl("body"), !0), 0 === n.items().length ? (n.throbber.show(), n.fire("loading")) : n.throbber.show(100, function () {
        ...
        lr = Pt.extend({
            ...
            postRender: function () {
                var t = this;
                t._super(), t.resizeDragHelper = new dt(this._id, {
                    start: function () {
                        t.fire("ResizeStart")
                    },
                    drag: function (e) {
    ...
    var cr = Pt.extend({
        ...
        renderHtml: function () {
            var e, t = this,
                n = "";
            return e = ur(t._options), t.size && (n = ' size = "' + t.size + '"'), '<select id="' + t._id + '" class="' + t.classes + '"' + n + ">" + e + "</select>"
        },
        bindStates: function () {
            var t = this;
    ...
    var mr = Pt.extend({
            init: function (e) {
                ...
                }), t._super(e), t.classes.add("slider"), "v" === e.orientation && t.classes.add("vertical"), t._minValue = q(e.minValue) ? e.minValue : 0, t._maxValue = q(e.maxValue) ? e.maxValue : 100, t._initValue = t.state.get("value")
            },
            renderHtml: function () {
                var e = this._id,
                    t = this.classPrefix;
            ...
            postRender: function () {
                ...
                e = m._minValue, t = m._maxValue, "v" === m.settings.orientation ? (n = "screenY", i = "top", r = "height", o = "h") : (n = "screenX", i = "left", r = "width", o = "w"), m._super(),
                    ...
                    }(e, t), s = e, a = t, l = m.getEl("handle"), m._dragHelper = new dt(m._id, {
                        handle: m._id + "-handle",
                        start: function (e) {
                            u = e[n], c = parseInt(m.getEl("handle").style[i], 10), d = (m.layoutRect()[o] || 100) - _e.getSize(l)[r], m.fire("dragstart", {
                                value: h
                            })
                        },
                        drag: function (e) {
        ...
        pr = ir.extend({
            ...
            repaint: function () {
                var e, t, n = this.getEl(),
                    i = this.layoutRect();
                return this._super(), e = n.firstChild, t = n.lastChild, xe(e).css({
                    width: i.w - _e.getSize(t).width,
                    height: i.h - 2
                }), xe(t).css({
                    height: i.h - 2
                }), this
        ...
        br = vt.extend({
            ...
            initLayoutRect: function () {
                var e, t, n, i = this;
                t = (t = _e.getSize(i.getEl("head")).width) < 0 ? 0 : t, n = 0, i.items().each(function (e) {
        ...
        yr = Pt.extend({
            ...
            renderHtml: function () {
                ...
                return t = {
                    ...
                    t[e] = i[e]
                }), n.disabled() && (t.disabled = "disabled"), i.subtype && (t.type = i.subtype), (e = _e.create(i.multiline ? "textarea" : "input", t)).value = n.state.get("value"), e.className = n.classes.toString(), e.outerHTML
            },
            value: function (e) {
        ...
        wr = function (n) {
            n.ui ? w.each(xr(), function (e, t) {
                n.ui[t] = e
            }) : n.ui = xr()
        };
    w.each(xr(), function (e, t) {
        b.add(t, e)
    }), wr(window.tinymce ? window.tinymce : {}), o.add("modern", function (e) {
