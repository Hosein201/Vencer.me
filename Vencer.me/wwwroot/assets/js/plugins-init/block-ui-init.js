(function ($) {
    ...
    $('#demo_1').click(function () {
        $.blockUI({
            message: '<h1 class="p-3">چند لحظه صبر کنید ...</h1>'
        });
    ...
    $('#demo_9').click(function () {
        $.blockUI();
        $('.blockOverlay').attr('title', 'برای رفع بلاک صفحه اینجا کلیک کنید').click($.unblockUI);
    });

    $('#demo_10').click(function () {
        $.blockUI({
            message: '<h1>لغو بلاک به صورت اتوماتیک!</h1>',
            timeout: 2000
        });
    });
    ...
    $('#demo_12').click(function () {
        $.growlUI('اعلان حالت Growl', 'روز خوبی داشته باشید!');
    });
