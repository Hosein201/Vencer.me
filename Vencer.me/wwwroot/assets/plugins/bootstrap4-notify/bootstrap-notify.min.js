! function (a) {
    ...
    function c(c, e, f) {
        ...
        if (f = a.extend(!0, {}, g, f), this.settings = a.extend(!0, {}, d, f), this._defaults = d, "-" === this.settings.content.target && (this.settings.content.target = this.settings.url_target), this.animations = {
                start: "webkitAnimationStart oanimationstart MSAnimationStart animationstart",
                end: "webkitAnimationEnd oanimationend MSAnimationEnd animationend"
            }, "number" == typeof this.settings.offset && (this.settings.offset = {
                x: this.settings.offset,
                y: this.settings.offset
            }), this.settings.allow_duplicates || !this.settings.allow_duplicates && !b(this)) {
            this.init();
            var h = a('[data-notify="container"]').length;
            this.settings.restrict > 0 && h >= this.settings.restrict && a('[data-notify="container"]').find('button[data-notify="dismiss"]').slice(0, h - this.settings.restrict).trigger("click")
        }
    }
    var d = {
        element: "body",
    ...
    String.format = function () {
        ...
        buildNotify: function () {
            ...
            this.$ele = a(String.format(this.settings.template, this.settings.type, b.title, b.message, b.url, b.target)), this.$ele.attr("data-notify-position", this.settings.placement.from + "-" + this.settings.placement.align), 0 === b.title.length && this.$ele.find('[data-notify="title"]').css("display", "none"), this.settings.allow_dismiss || this.$ele.find('[data-notify="dismiss"]').css("display", "none"), (this.settings.delay <= 0 && !this.settings.showProgressbar || !this.settings.showProgressbar) && this.$ele.find('[data-notify="progressbar"]').remove(), 0 !== b.id.length && this.$ele.find('[data-notify="dismiss"]').attr("data-notify-id", b.id)
        },
        setIcon: function () {
        ...
        bind: function () {
            ...
            this.$ele.find('[data-notify="dismiss"]').on("click", function () {
                a.isFunction(b.settings.onDismiss) && b.settings.onDismiss.call(this), b.close()
            ...
            }), this.$ele.data("data-hover", "false"), this.settings.delay > 0 && (b.$ele.data("notify-delay", b.settings.delay), this.timerInterval = setInterval(function () {
                ...
                if ("false" === b.$ele.data("data-hover") && "pause" === b.settings.mouse_over || "pause" != b.settings.mouse_over) {
                    ...
                    b.$ele.data("notify-delay", c), b.$ele.find('[data-notify="progressbar"] > div').attr("aria-valuenow", d).css("width", d + "%")
                }
                c <= -b.settings.timer && (a.isFunction(b.settings.onTimer) && b.settings.onTimer.call(b.$ele), b.close())
            }, b.settings.timer))
        },
        close: function () {
            ...
            this.$ele.attr("data-closing", "true").addClass(this.settings.animate.exit), b.reposition(c), a.isFunction(b.settings.onClose) && b.settings.onClose.call(this.$ele), this.$ele.one(this.animations.start, function () {
                ...
                d || (b.$ele.remove(), a.isFunction(b.settings.onClosed) && b.settings.onClosed.call(this))
            }, 600)
        },
